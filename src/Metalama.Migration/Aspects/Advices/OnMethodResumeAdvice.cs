...
namespace PostSharp.Aspects.Advices
{
    ...
    ///   that this method is an advice having the same semantics as <see cref = "OnMethodBoundaryAspect.OnResume" />.
    /// </summary>
    /// <remarks>
    ///   <para>
    ///     The method to which this custom attribute is applied must be public and must have the same signature as
    ///     <see cref = "OnMethodBoundaryAspect.OnResume" />. However, it can be static.
    ///   </para>
    ///   <br />
