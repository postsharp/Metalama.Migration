...
namespace PostSharp.Aspects.Advices
{
    ...
    public sealed class IntroduceMemberAttribute : Advice, IIntroduceMemberAdviceProperties
    {
        ...
        {
            get { return this.isVirtual ?? false; }
            set { this.isVirtual = value; }
        }

        bool? IIntroduceMemberAdviceProperties.IsVirtual { get { return this.isVirtual; }}

        /// <summary>
        ///   Determines whether the <see cref = "IsVirtual" /> property has been specified.
        /// </summary>
        public bool IsIsVirtualSpecified
        {
            get { return this.isVirtual.HasValue; }
        }
